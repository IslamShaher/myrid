...
class RideModel {
  ...
  String? startTime;
  String? endTime;
  String? fareScreenshot;
  String? fareAmountText;
  String? rider1Fare;
  String? rider2Fare;
  ...
  factory RideModel.fromJson(Map<String, dynamic> json) => RideModel(
        ...
        serviceId: json["service_id"]?.toString() ?? '0',
        ...
        recommendAmount: json["recommend_amount"]?.toString() ?? '0',
        minAmount: json["min_amount"]?.toString() ?? '0',
        maxAmount: json["max_amount"]?.toString() ?? '0',
        offerAmount: json["amount"]?.toString() ?? '0',
        ...
        numberOfPassenger: json["number_of_passenger"]?.toString() ?? '1',
        otp: json["otp"]?.toString() ?? '',
        amount: json["amount"]?.toString() ?? '0',
        rideType: json["ride_type"]?.toString() ?? '0',
        status: json["status"]?.toString() ?? '0',
        paymentType: json["payment_type"]?.toString() ?? '0',
        paymentStatus: json["payment_status"]?.toString() ?? '0',
        gatewayCurrencyId: json["gateway_currency_id"]?.toString() ?? '0',
        ...
        fareScreenshot: json["fare_screenshot"]?.toString(),
        fareAmountText: json["fare_amount_text"]?.toString(),
        rider1Fare: json["rider1_fare"]?.toString(),
        rider2Fare: json["rider2_fare"]?.toString(),
        sharedRideSequence: json["shared_ride_sequence"] != null ? (json["shared_ride_sequence"] is List ? (json["shared_ride_sequence"] as List).map((e) => e.toString()).toList() : null) : null,
